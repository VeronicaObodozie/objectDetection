...
def data_load(batch_size, num_workers):
    # Data location
    train_list_path = '/aerial/train3.txt'
    test_list_path = '/aerial/test3.txt'
    img_dir ="aerial/data/images"
    ann_dir ="aerial/data/annotations"
    ...
    train_set = AerialCarsDataset(train_list_path, img_dir, ann_dir, 1224, 724, transforms=data_transforms)
    # val_set = AerialCarsDataset(list_path, files_dir_val+'/images',files_dir_val+'/annotations', 1224, 724, transforms=data_transforms)
    test_set = AerialCarsDataset(test_list_path, img_dir, ann_dir, 1224, 724, transforms=data_transforms)

    # split the train dataset in train and val set
    ...
    val_dataloader = DataLoader(val_set, batch_size=batch_size, shuffle=False, num_workers=num_workers, collate_fn=utils.collate_fn)
    test_dataloader = DataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=num_workers, collate_fn=utils.collate_fn)
